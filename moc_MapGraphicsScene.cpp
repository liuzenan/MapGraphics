...
**
** Created: Sun Apr 14 22:06:10 2013
...
const QMetaObject MapGraphicsScene::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MapGraphicsScene,
      qt_meta_data_MapGraphicsScene, 0 }
};
...
int MapGraphicsScene::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: objectAdded((*reinterpret_cast< MapGraphicsObject*(*)>(_a[1]))); break;
        case 1: objectRemoved((*reinterpret_cast< MapGraphicsObject*(*)>(_a[1]))); break;
        case 2: handleNewObjectGenerated((*reinterpret_cast< MapGraphicsObject*(*)>(_a[1]))); break;
        case 3: handleObjectDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
