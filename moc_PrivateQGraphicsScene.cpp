...
**
** Created: Sun Apr 14 19:54:19 2013
...
const QMetaObject PrivateQGraphicsScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_PrivateQGraphicsScene,
      qt_meta_data_PrivateQGraphicsScene, 0 }
};
...
int PrivateQGraphicsScene::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: handleMGObjectAdded((*reinterpret_cast< MapGraphicsObject*(*)>(_a[1]))); break;
        case 1: handleMGObjectRemoved((*reinterpret_cast< MapGraphicsObject*(*)>(_a[1]))); break;
        case 2: handleZoomLevelChanged(); break;
        case 3: handleSelectionChanged(); break;
        default: ;
        }
        _id -= 4;
    }
